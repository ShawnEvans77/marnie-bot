'''Marnie's help command.'''

command = "!dt {query} - Returns information on Pokemon, Pokemon abilities, Pokemon items, or Pokemon moves.\n" \
          "!weak {type} - Lists weaknesses, resistances, and immunities of a given type. You can query a dual type Pokemon by sending two types seperated by slashes or commas to the command. For example, !dt fire/water or !dt fire,water.\n" \
